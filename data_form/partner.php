	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				<div class="text-success">
					<h4>Your Partner preferences</h4>
				</div>
			</div>
			<div class="col-sm-6">
		...
		<form>
			<div class="form-group">
				<span for="name" class="pertner_text">Partner Gender <code>*</code> <label>:</label> </span>
			...
			<div class="form-group">
				<span for="name" class="pertner_text">Height <code>*</code> <label>:</label></span>
				<select></select>
			</div>
		</form>
